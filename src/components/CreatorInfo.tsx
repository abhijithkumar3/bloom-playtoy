    ...
    <div className="fixed bottom-6 left-6 z-50">
      <Dialog>
        <DialogTrigger asChild>
          <Button variant="outline" size="icon" className="rounded-full bg-background/50 backdrop-blur-md border-white/20 hover:bg-background/80 transition-all shadow-lg text-foreground w-12 h-12">
